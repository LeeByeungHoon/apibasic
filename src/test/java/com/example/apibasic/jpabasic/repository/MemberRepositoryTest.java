...
//    @Rollback
    ...
    void findByGenderTest() {
        ...
        list.forEach(m -> {
            ...
            assertSame(m.getGender(), FEMALE);
        });
    }

    @Test
    @DisplayName("쿼리메서드를 사용해서 계정 명이 abc4321 이면서 남성인 회원을 조회해야 한다.")
    ...
    @Test
    @DisplayName("JPQL을 사용해서 닉네임에 '박'이 포함된 회원만 조회해야 한다.")
    void jpqlTest3() {
        // given
        String nickName = "박";
        // when
